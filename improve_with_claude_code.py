...
def _build_phase1_prompt(history: list, branch_name: str) -> str:
    from services.history import get_top_tweets
...
# Verification helpers extracted to improve/verify.py so they can be reused by
# scripts/verify_quality.py without importing from this orchestrator script.
