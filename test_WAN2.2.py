#!/usr/bin/env python3
"""
test_WAN2.2.py — Wan2.2 TI2V-5B Image-to-Video  (720p, ~24 GB RAM)
...
directly with the standard 720p 5B int8 parameters.
...
Examples:
    ...
    /home/y/Programming/Wan2GP/venv/bin/python test_WAN2.2.py Images/photo.png "subtle motion" --steps 50 --seed 42
    /home/y/Programming/Wan2GP/venv/bin/python test_WAN2.2.py Images/photo.png "subtle motion" --steps 50 --frames 121
...
Model download (one-time if not yet present):
...
def print_run_banner(
    *,
    ...
    print()
    print("═" * 64)
    print("  Wan2.2 TI2V 5B  ·  Wan2GP  ·  720p 5B int8")
    print("═" * 64)
    print()
    print("  RUN")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Wan2.2 TI2V-5B 720p Image-to-Video — run from XBot 3 project root"
    )
    ...
    parser.add_argument("--frames", type=int, default=121,
                        help="Frames (default: 121 = ~5 s @ 24 fps)")
